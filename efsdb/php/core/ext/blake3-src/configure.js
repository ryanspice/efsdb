...
var PHP_DIR = "B:\\Dev\\PHPFS\\.cache\\873fa5fd\\php-dev"
...
if (PHP_BLAKE3 != 'no') {
	...
	EXTENSION('blake3', 'php_blake3.c blake3.c blake3_dispatch.c blake3_portable.c', true, '/DZEND_ENABLE_STATIC_TSRMLS_CACHE=1');
}
