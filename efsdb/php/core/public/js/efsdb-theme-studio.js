...
var h = (e, t, r) => (ts(e, t, "read from private field"), r ? r.call(e) : t.get(e)), C = (e, t, r) => t.has(e) ? ra("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), T = (e, t, r, n) => (ts(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), K = (e, t, r) => (ts(e, t, "access private method"), r);
var ja;
...
const ge = 2, kn = 4, Oi = 8, Ia = 1 << 24, wr = 16, _t = 32, pr = 64, hs = 128, it = 512, pe = 1024, Se = 2048, Rt = 4096, Ze = 8192, st = 16384, gr = 32768, fs = 1 << 25, Br = 65536, sa = 1 << 17, Sl = 1 << 18, Zr = 1 << 19, $l = 1 << 20, zt = 1 << 25, Ur = 65536, ps = 1 << 21, Ps = 1 << 22, hr = 1 << 23, Xn = Symbol("$state"), Oa = Symbol("legacy props"), jl = Symbol(""), Ht = new class extends Error {
  constructor() {
    super(...arguments);
...
function Ts(e) {
  (e.f & it) !== 0 || e.deps === null ? ce(e, pe) : ce(e, Rt);
}
function Ya(e) {
  if (e !== null)
    for (const t of e)
...
function Yl(e, t = hn) {
  ...
  function a(o, c = hn) {
    const l = [o, c];
    return n.add(l), n.size === 1 && (r = t(i, s) || hn), o(
      /** @type {T} */
      e
    ), () => {
...
const Pi = class Pi {
  ...
  flush() {
    try {
      rs = !0, L = this, K(this, $e, ws).call(this);
    } finally {
...
pn = new WeakMap(), mn = new WeakMap(), vn = new WeakMap(), wn = new WeakMap(), ti = new WeakMap(), He = new WeakMap(), Or = new WeakMap(), Ft = new WeakMap(), Bt = new WeakMap(), gn = new WeakMap(), $e = new WeakSet(), vs = function() {
  ...
  var o, c;
  if (aa++ > 1e3 && (Er.delete(this), Kl()), !K(this, $e, vs).call(this)) {
    for (const l of h(this, Or))
      h(this, Ft).delete(l), ce(l, Se), this.schedule(l);
    for (const l of h(this, Ft))
      ce(l, Rt), this.schedule(l);
  }
  const t = h(this, He);
  ...
  if (cn = null, xi = null, K(this, $e, vs).call(this)) {
    K(this, $e, bs).call(this, n), K(this, $e, bs).call(this, r);
    for (const [l, f] of h(this, Bt))
      Ja(l, f);
  } else {
    h(this, vn) === 0 && Er.delete(this), h(this, Or).clear(), h(this, Ft).clear();
    for (const l of h(this, pn)) l(this);
  ...
  if (h(this, He).length > 0) {
    const l = a ?? (a = this);
    h(l, He).push(...h(this, He).filter((f) => !h(l, He).includes(f)));
  }
  a !== null && (Er.add(a), K(c = a, $e, ws).call(c)), Er.has(this) || K(this, $e, Za).call(this);
}, /**
...
gs = function(t, r, n) {
  ...
  for (var i = t.first; i !== null; ) {
    var s = i.f, a = (s & (_t | pr)) !== 0, o = a && (s & pe) !== 0, c = o || (s & Ze) !== 0 || h(this, Bt).has(i);
    if (!c && i.fn !== null) {
...
function oa(e) {
  ...
  if (t !== 0) {
    for (var r = 0; r < t; ) {
      var n = e[r++];
      if ((n.f & (st | Ze)) === 0 && di(n) && (gt = /* @__PURE__ */ new Set(), Sn(n), n.deps === null && n.first === null && n.nodes === null && n.teardown === null && n.ac === null && xo(n), (gt == null ? void 0 : gt.size) > 0)) {
        fr.clear();
        for (const i of gt) {
          if ((i.f & (st | Ze)) !== 0) continue;
          const s = [i];
          let a = i.parent;
          for (; a !== null; )
...
var Fe, ri, St, Dr, Ce, $t, Be, bt, Ut, Nr, dr, bn, ni, ii, Yt, Ti, se, eo, to, ro, ys, _i, ki, xs;
class td {
  /**
  ...
  update_pending_count(t, r) {
    K(this, se, xs).call(this, t, r), T(this, Nr, h(this, Nr) + t), !(!h(this, Yt) || h(this, bn)) && (T(this, bn, !0), Xt(() => {
  ...
  error(t) {
    ...
    if (!r && !n)
      throw t;
    h(this, $t) && (Pe(h(this, $t)), T(this, $t, null)), h(this, Be) && (Pe(h(this, Be)), T(this, Be, null)), h(this, bt) && (Pe(h(this, bt)), T(this, bt, null)), B && (Ie(
      /** @type {TemplateNode} */
      h(this, ri)
    ), Tr(), Ie(zi()));
    var i = !1, s = !1;
    const a = () => {
      ...
      i = !0, s && Wl(), h(this, bt) !== null && Hr(h(this, bt), () => {
        T(this, bt, null);
      ...
      try {
        ...
        ur(l, h(this, Ce) && h(this, Ce).parent);
      }
      n && T(this, bt, K(this, se, ki).call(this, () => {
        try {
          return nt(() => {
            var l = (
              /** @type {Effect} */
    ...
    Xt(() => {
      ...
      c.then == "function" ? c.then(
        o,
        /** @param {unknown} e */
        (l) => ur(l, h(this, Ce) && h(this, Ce).parent)
      ) : o(c);
    });
  }
}
Fe = new WeakMap(), ri = new WeakMap(), St = new WeakMap(), Dr = new WeakMap(), Ce = new WeakMap(), $t = new WeakMap(), Be = new WeakMap(), bt = new WeakMap(), Ut = new WeakMap(), Nr = new WeakMap(), dr = new WeakMap(), bn = new WeakMap(), ni = new WeakMap(), ii = new WeakMap(), Yt = new WeakMap(), Ti = new WeakMap(), se = new WeakSet(), eo = function() {
  try {
    T(this, $t, nt(() => h(this, Dr).call(this, h(this, Fe))));
  } catch (t) {
    this.error(t);
  }
}, /**
...
to = function(t) {
  ...
  t && (this.is_pending = !0, T(this, Be, nt(() => t(h(this, Fe)))), Xt(() => {
    var r = T(this, Ut, document.createDocumentFragment()), n = at();
    r.append(n), T(this, $t, K(this, se, ki).call(this, () => nt(() => h(this, Dr).call(this, n)))), h(this, dr) === 0 && (h(this, Fe).before(r), T(this, Ut, null), Hr(
      /** @type {Effect} */
      h(this, Be),
      () => {
        T(this, Be, null);
  ...
  try {
    if (this.is_pending = this.has_pending_snippet(), T(this, dr, 0), T(this, Nr, 0), T(this, $t, nt(() => {
...
ki = function(t) {
  var r = W, n = O, i = Oe;
  Et(h(this, Ce)), lt(h(this, Ce)), qn(h(this, Ce).ctx);
  try {
    return mr.ensure(), t();
  } catch (s) {
    return Ua(s), null;
...
xs = function(t, r) {
  ...
  T(this, dr, h(this, dr) + t), h(this, dr) === 0 && (K(this, se, _i).call(this, r), h(this, Be) && Hr(h(this, Be), () => {
    T(this, Be, null);
...
function rd(e, t, r, n) {
  ...
  var a = (
    /** @type {Effect} */
    W
  ), o = nd(), c = s.length === 1 ? s[0].promise : s.length > 1 ? Promise.all(s.map((p) => p.promise)) : null;
  function l(p) {
    o();
    try {
      n(p);
  ...
  var f = no();
  function m() {
    Promise.all(r.map((p) => /* @__PURE__ */ id(p))).then((p) => l([...t.map(i), ...p])).catch((p) => ur(p, a)).finally(() => f());
  }
  c ? c.then(() => {
    o(), m(), Ri();
  }) : m();
...
function nd() {
  ...
  return function(s = !0) {
    Et(e), lt(t), qn(r), s && (e.f & st) === 0 && (n == null || n.activate(), n == null || n.apply());
  };
}
function Ri(e = !0) {
  Et(null), lt(null), qn(null), e && (L == null || L.deactivate());
}
function no() {
  var e = (
    /** @type {Boundary} */
...
function id(e, t, r) {
  ...
  return pd(() => {
    ...
    i = l.promise;
    try {
      Promise.resolve(e()).then(l.resolve, l.reject).finally(Ri);
    } catch (g) {
      l.reject(g), Ri();
    }
    var f = (
    ...
    l.promise.then(p, (g) => p(null, g || "unknown"));
  }), wo(() => {
...
function w(e, t, r = !1) {
  ...
  (!xt || (O.f & sa) !== 0) && Fa() && (O.f & (ge | wr | Ps | sa)) !== 0 && (ot === null || !_n.call(ot, e)) && Nl();
  let n = r ? Cr(t) : t;
  return Mn(e, n, xi);
}
function Mn(e, t, r = null) {
  if (!e.equals(t)) {
    ...
    e.wv = So(), co(e, Se, r), W !== null && (W.f & pe) !== 0 && (W.f & (_t | pr)) === 0 && (et === null ? wd([e]) : et.push(e)), !i.is_fork && _s.size > 0 && !oo && ld();
  }
  return t;
}
function ld() {
...
function co(e, t, r) {
  ...
  if (n !== null)
    for (var i = n.length, s = 0; s < i; s++) {
      var a = n[s], o = a.f, c = (o & Se) === 0;
      if (c && ce(a, t), (o & ge) !== 0) {
        var l = (
          /** @type {Derived} */
          a
        );
        _e == null || _e.delete(l), (o & Ur) === 0 && (o & it && (a.f |= Ur), co(l, Rt, r));
      } else if (c) {
        var f = (
          /** @type {Effect} */
          a
        );
        (o & wr) !== 0 && gt !== null && gt.add(f), r !== null ? r.push(f) : As(f);
      }
    }
}
function Cr(e) {
  ...
  return n && r.set("length", /* @__PURE__ */ I(
    ...
    e,
    {
      defineProperty(o, c, l) {
        (!("value" in l) || l.configurable === !1 || l.enumerable === !1 || l.writable === !1) && Ol();
        var f = r.get(c);
        return f === void 0 ? a(() => {
          var m = /* @__PURE__ */ I(l.value);
          return r.set(c, m), m;
        }) : w(f, l.value, !0), !0;
      },
      deleteProperty(o, c) {
      ...
      get(o, c, l) {
        ...
        if (c === Xn)
          return e;
        var f = r.get(c), m = c in o;
        if (f === void 0 && (!m || (y = Vr(o, c)) != null && y.writable) && (f = a(() => {
          var g = Cr(m ? o[c] : xe), z = /* @__PURE__ */ I(g);
          return z;
        }), r.set(c, f)), f !== void 0) {
          var p = d(f);
      ...
      getOwnPropertyDescriptor(o, c) {
        ...
        if (l && "value" in l) {
          ...
          var m = r.get(c), p = m == null ? void 0 : m.v;
          if (m !== void 0 && p !== xe)
            return {
              enumerable: !0,
              configurable: !0,
      ...
      has(o, c) {
        ...
        if (c === Xn)
          return !0;
        var l = r.get(c), f = l !== void 0 && l.v !== xe || Reflect.has(o, c);
        if (l !== void 0 || W !== null && (!f || (p = Vr(o, c)) != null && p.writable)) {
          l === void 0 && (l = a(() => {
            var y = f ? Cr(o[c]) : xe, g = /* @__PURE__ */ I(y);
            return g;
          }), r.set(c, l));
          var m = d(l);
          if (m === xe)
      ...
      set(o, c, l, f) {
        ...
        if (m === void 0)
          (!p || (k = Vr(o, c)) != null && k.writable) && (m = a(() => /* @__PURE__ */ I(void 0)), w(m, Cr(l)), r.set(c, m));
        else {
          p = m.v !== xe;
          var z = a(() => Cr(l));
          w(m, z);
...
function ko(e, t) {
  if ((e.f & Ze) !== 0) {
    ...
    for (var r = e.first; r !== null; ) {
      var n = r.next, i = (r.f & Br) !== 0 || (r.f & _t) !== 0;
      ko(r, i ? t : !1), r = n;
    }
...
let ot = null;
function qo(e) {
  O !== null && (ot === null ? ot = [e] : ot.push(e));
}
let Le = null, Ve = 0, et = null;
function wd(e) {
  et = e;
}
let Mo = 1, Lr = 0, Fr = Lr;
...
function jo(e) {
  var z;
  var t = Le, r = Ve, n = et, i = O, s = ot, a = Oe, o = xt, c = Fr, l = e.f;
  Le = /** @type {null | Value[]} */
  null, Ve = 0, et = null, O = (l & (_t | pr)) === 0 ? e : null, ot = null, qn(e.ctx), xt = !1, Fr = ++Lr, e.ac !== null && (Bi(() => {
    e.ac.abort(Ht);
  }), e.ac = null);
  try {
    e.f |= ps;
    ...
    if (Le !== null) {
      ...
      if (Os() && (e.f & it) !== 0)
        for (g = Ve; g < p.length; g++)
          ((z = p[g]).reactions ?? (z.reactions = [])).push(e);
    } else !y && p !== null && Ve < p.length && (ei(e, Ve), p.length = Ve);
    if (Fa() && et !== null && !xt && p !== null && (e.f & (ge | Rt | Se)) === 0)
    ...
    e.f ^= ps, Le = t, Ve = r, et = n, O = i, ot = s, qn(a), xt = o, Fr = c;
  }
}
function gd(e, t) {
  let r = t.reactions;
  ...
  (Le === null || !_n.call(Le, t))) {
    ...
    (s.f & it) !== 0 && (s.f ^= it, s.f &= ~Ur), Ts(s), od(s), ei(s, 0);
  }
}
function ei(e, t) {
  var r = e.deps;
...
function d(e) {
  ...
  if (r) {
    ...
    var c = (a.f & it) === 0 && !xt && O !== null && (qi || (O.f & it) !== 0), l = (a.f & gr) === 0;
    di(a) && (c && (a.f |= it), so(a)), c && !l && (ao(a), zo(a));
  }
  if (_e != null && _e.has(e))
    return _e.get(e);
  if ((e.f & hr) !== 0)
  ...
  i[a] || e.target, s !== t) {
    ...
    try {
      for (var p, y = []; s !== null; ) {
        ...
        s.host || null;
        try {
          var z = (q = s[Ir]) == null ? void 0 : q[n];
          z != null && (!/** @type {any} */
          s.disabled || // DOM could've been updated already by the time this is reached, so we check this as well
          // -> the target could not have been disabled because it emits the event in the first place
          e.target === s) && z.call(s, e);
        } catch (A) {
          p ? y.push(A) : p = A;
        }
      ...
      e[Ir] = t, delete e.currentTarget, lt(f), Et(m);
    }
  }
}
var Ra;
  ...
  var c = void 0, l = fd(() => {
    ...
    ed(
      ...
      (y) => {
        ...
        if (s && (g.c = s), i && (n.$$events = i), B && fn(
          /** @type {TemplateNode} */
          y,
          null
        ), c = e(y, n) || {}, B && (W.nodes.end = N, N === null || N.nodeType !== li || /** @type {Comment} */
        N.data !== Es))
          throw Ni(), xn;
        Hi();
      },
      ...
      for (var g = 0; g < y.length; g++) {
        ...
        if (!m.has(z)) {
          ...
          for (const k of [t, document]) {
            ...
            var A = q.get(z);
            A === void 0 ? (k.addEventListener(z, Ms, { passive: b }), q.set(z, 1)) : q.set(z, A + 1);
          }
        }
      }
    };
    return p(Ii(Eo)), qs.add(p), () => {
      ...
      for (var y of m)
        for (const q of [t, document]) {
          ...
          --z == 0 ? (q.removeEventListener(y, Ms), g.delete(y), g.size === 0 && bi.delete(q)) : g.set(y, z);
        }
...
class Lo {
  ...
  constructor(t, r = !0) {
    ...
    C(this, ai, (t) => {
      if (h(this, yt).has(t)) {
        ...
        for (const [s, a] of h(this, yt)) {
          if (h(this, yt).delete(s), s === t)
            break;
        ...
        for (const [s, a] of h(this, jt)) {
          ...
          const o = () => {
            if (Array.from(h(this, yt).values()).includes(s)) {
              var l = document.createDocumentFragment();
              Vs(a, l), l.append(at()), h(this, Ue).set(s, { effect: a, fragment: l });
            } else
              Pe(a);
    ...
    C(this, Ai, (t) => {
      h(this, yt).delete(t);
      const r = Array.from(h(this, yt).values());
   ...
   */
    ...
    if (h(this, yt).set(n, t), i) {
      for (const [o, c] of h(this, jt))
        o === t ? n.unskip_effect(c) : n.skip_effect(c);
      for (const [o, c] of h(this, Ue))
        o === t ? n.unskip_effect(c.effect) : n.skip_effect(c.effect);
      n.oncommit(h(this, ai)), n.ondiscard(h(this, Ai));
    } else
      B && (this.anchor = N), h(this, ai).call(this, n);
  }
}
yt = new WeakMap(), jt = new WeakMap(), Ue = new WeakMap(), Wr = new WeakMap(), si = new WeakMap(), ai = new WeakMap(), Ai = new WeakMap();
function jd(e, t, ...r) {
  var n = new Lo(e);
  Yi(() => {
    const i = t() ?? null;
  ...
  function a(o, c) {
    if (B) {
      ...
      if (o !== parseInt(l.substring(1))) {
        var f = zi();
        Ie(f), i.anchor = f, Zt(!1), i.ensure(o, c), Zt(!0);
        return;
      }
    }
    i.ensure(o, c);
...
function Qn(e, t, r, n, i, s = null) {
  var a = e, o = /* @__PURE__ */ new Map(), c = (t & Ea) !== 0;
  if (c) {
    var l = (
      /** @type {Element} */
      e
    );
    a = B ? Ie(/* @__PURE__ */ Gr(l)) : l.appendChild(at());
  }
  B && Wi();
  ...
  function z(k) {
    (A.effect.f & st) === 0 && (A.pending.delete(k), A.fallback = f, Rd(A, p, a, t, n), f !== null && (p.length === 0 ? (f.f & zt) === 0 ? Ws(f) : (f.f ^= zt, Yn(f, null, a)) : Hr(f, () => {
      f = null;
    })));
  }
  function b(k) {
  ...
  var q = Yi(() => {
    ...
    if (B) {
      var te = Na(a) === Rs;
      te !== (k === 0) && (a = zi(), Ie(a), Zt(!1), H = !0);
    }
    for (var Q = /* @__PURE__ */ new Set(), Y = (
      /** @type {Batch} */
      L
    ), ue = mo(), R = 0; R < k; R += 1) {
      B && N.nodeType === li && /** @type {Comment} */
      N.data === Es && (a = /** @type {Comment} */
      N, H = !0, Zt(!1));
      var me = p[R], ve = n(me, R), de = g ? null : o.get(ve);
      de ? (de.v && Mn(de.v, me), de.i && Mn(de.i, R), ue && Y.unskip_effect(de.e)) : (de = Ed(
        o,
        g ? a : fa ?? (fa = at()),
        me,
        ve,
        ...
        t,
        r
      ), g || (de.e.f |= zt), o.set(ve, de)), Q.add(ve);
    }
    if (k === 0 && s && !f && (g ? f = nt(() => s(a)) : (f = nt(() => s(fa ?? (fa = at()))), f.f |= zt)), k > Q.size && El(), B && k > 0 && Ie(zi()), !g)
      if (y.set(Y, Q), ue) {
        for (const [De, Xe] of o)
          Q.has(De) || Y.skip_effect(Xe.e);
        Y.oncommit(z), Y.ondiscard(b);
      } else
        z(Y);
    H && Zt(!0), d(m);
...
function Rd(e, t, r, n, i) {
  var me, ve, de, De, Xe, Kr, br, kt, At;
  var s = (n & hl) !== 0, a = t.length, o = e.items, c = Fn(e.effect.first), l, f = null, m, p = [], y = [], g, z, b, q;
  if (s)
    for (q = 0; q < a; q += 1)
      g = t[q], z = i(g, q), b = /** @type {EachItem} */
      o.get(z).e, (b.f & zt) === 0 && ((ve = (me = b.nodes) == null ? void 0 : me.a) == null || ve.measure(), (m ?? (m = /* @__PURE__ */ new Set())).add(b));
  for (q = 0; q < a; q += 1) {
    if (g = t[q], z = i(g, q), b = /** @type {EachItem} */
    o.get(z).e, e.outrogroups !== null)
    ...
    if ((b.f & Ze) !== 0 && (Ws(b), s && ((De = (de = b.nodes) == null ? void 0 : de.a) == null || De.unfix(), (m ?? (m = /* @__PURE__ */ new Set())).delete(b))), (b.f & zt) !== 0)
      if (b.f ^= zt, b === c)
        ...
        var A = f ? f.next : c;
        b === e.effect.last && (e.effect.last = b.prev), b.prev && (b.prev.next = b.next), b.next && (b.next.prev = b.prev), or(e, f, b), or(e, b, A), Yn(b, A, r), f = b, p = [], y = [], c = Fn(f.next);
        continue;
      }
    if (b !== c) {
      if (l !== void 0 && l.has(b)) {
        if (p.length < y.length) {
          var k = y[0], H;
          f = k.prev;
          var te = p[0], Q = p[p.length - 1];
          for (H = 0; H < p.length; H += 1)
            Yn(p[H], k, r);
          for (H = 0; H < y.length; H += 1)
            l.delete(y[H]);
          or(e, te.prev, Q.next), or(e, f, te), or(e, Q, k), c = k, f = Q, q -= 1, p = [], y = [];
        } else
          l.delete(b), Yn(b, c, r), or(e, b.prev, b.next), or(e, b, f === null ? e.effect.first : f.next), or(e, f, b), f = b;
        continue;
      }
      for (p = [], y = []; c !== null && c !== b; )
        (l ?? (l = /* @__PURE__ */ new Set())).add(c), y.push(c), c = Fn(c.next);
      if (c === null)
        continue;
    }
    (b.f & zt) === 0 && p.push(b), f = b, c = Fn(b.next);
  }
  if (e.outrogroups !== null) {
    for (const je of e.outrogroups)
      je.pending.size === 0 && ($s(e, Ii(je.done)), (Xe = e.outrogroups) == null || Xe.delete(je));
  ...
  if (c !== null || l !== void 0) {
    ...
    if (l !== void 0)
      for (b of l)
        (b.f & Ze) === 0 && Y.push(b);
    for (; c !== null; )
      (c.f & Ze) === 0 && c !== e.fallback && Y.push(c), c = Fn(c.next);
    var ue = Y.length;
    if (ue > 0) {
      var R = (n & Ea) !== 0 && a === 0 ? r : null;
      if (s) {
        for (q = 0; q < ue; q += 1)
...
function Ed(e, t, r, n, i, s, a, o) {
  var c = (a & cl) !== 0 ? (a & fl) === 0 ? /* @__PURE__ */ lo(r, !1, !1) : Yr(r) : null, l = (a & ul) !== 0 ? Yr(i) : null;
  return {
    v: c,
    i: l,
    e: nt(() => (s(t, c ?? r, l ?? i, o), () => {
      ...
      for (var m = 0; m < z; m++) {
        ...
        if (o ? p === "/" && e[m - 1] === "*" && (o = !1) : s ? s === p && (s = !1) : p === "/" && e[m + 1] === "*" ? o = !0 : p === '"' || p === "'" ? s = p : p === "(" ? a++ : p === ")" && a--, !o && s === !1 && a === 0) {
          if (p === ":" && f === -1)
            ...
            if (f !== -1) {
              var y = is(e.substring(l, f).trim());
              if (!c.includes(y)) {
                p !== ";" && m++;
                var g = e.substring(l, m).trim();
                r += " " + g + ";";
              }
            }
            l = m + 1, f = -1;
...
function rt(e, t, r, n, i, s) {
  ...
  if (B || a !== r || a === void 0) {
    var o = Ad(r, n, s);
    (!B || o !== e.getAttribute("class")) && (o == null ? e.removeAttribute("class") : e.className = o), e.__className = r;
  } else if (s && i !== s)
    for (var c in s) {
      var l = !!s[c];
...
function Ge(e, t, r, n) {
  ...
  if (B || i !== t) {
    var s = Cd(t, n);
    (!B || s !== e.getAttribute("style")) && (s == null ? e.removeAttribute("style") : e.style.cssText = s), e.__style = t;
...
function ne(e, t, r, n) {
  var i = Do(e);
  B && (i[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === Od) || i[t] !== (i[t] = r) && (t === "loading" && (e[jl] = r), r == null ? e.removeAttribute(t) : typeof r != "string" && Wd(e).includes(t) ? e[t] = r : e.setAttribute(t, r));
}
function Do(e) {
  return (
...
const Li = class Li {
  ...
  observe(t, r) {
    ...
    return n.add(r), h(this, cr).set(t, n), K(this, Ci, No).call(this).observe(t, h(this, oi)), () => {
...
function zs(e = {}, t, r, n) {
  ...
  return Ds(() => {
    ...
    return Ui(() => {
      ...
      let c = s;
      for (; c !== i && c.parent !== null && c.parent.f & fs; )
        c = c.parent;
      const l = () => {
        o && ga(r(...o), e) && t(null, ...o);
      }, f = c.teardown;
...
function V(e, t, r, n) {
  ...
  if (i) {
    ...
    l = ((A = Vr(e, t)) == null ? void 0 : A.set) ?? (f && t in e ? (k) => e[t] = k : void 0);
  }
  var m, p = !1;
  i ? [m, p] = Zl(() => (
    /** @type {V} */
  ...
  e[t], m === void 0 && n !== void 0 && (m = c(), l && (Il(), l(m)));
  var y;
  if (y = () => {
    var k = (
      /** @type {V} */
  ...
  if (l) {
    ...
    return (
      /** @type {() => V} */
      (function(k, H) {
        return arguments.length > 0 ? ((!H || g || p) && l(H ? y() : k), k) : y();
      })
    );
  }
  var z = !1, b = ((r & pl) !== 0 ? Fi : io)(() => (z = !1, y()));
  i && d(b);
  var q = (
    /** @type {Effect} */
    W
  ...
  return (
    ...
    (function(k, H) {
      if (arguments.length > 0) {
        const te = H ? d(b) : i ? Cr(k) : k;
        return w(b, te), z = !0, a !== void 0 && (a = te), k;
      }
      return vr && z || (q.f & st) !== 0 ? b.v : d(b);
    })
  );
}
function Hd(e) {
  ...
  constructor(t) {
    ...
    const i = new Proxy(
      { ...t.props || {}, $$events: {} },
      {
        ...
        set(a, o, c) {
          return w(r.get(o) ?? n(o, c), c), Reflect.set(a, o, c);
        }
      }
    );
    T(this, tt, (t.hydrate ? Sd : Ao)(t.component, {
      target: t.target,
      anchor: t.anchor,
      props: i,
      context: t.context,
    ...
    for (const a of Object.keys(h(this, tt)))
    ...
    h(this, tt).$set = /** @param {Record<string, any>} next */
    (a) => {
      Object.assign(i, a);
    }, h(this, tt).$destroy = () => {
      $d(h(this, tt));
...
function Fs(e, t, r, n, i, s) {
  ...
  return $i(t).forEach((o) => {
    ji(a.prototype, o, {
      ...
      set(c) {
        var m;
        c = Mi(o, c, t), this.$$d[o] = c;
        var l = this.$$c;
        if (l) {
          var f = (m = Vr(l, o)) == null ? void 0 : m.get;
          f ? l[o] = c : l.$set({ [o]: c });
        }
      }
    });
...
function Mt(e, t) {
  Vi(t, !0), Hs(e, Xd);
  let r = V(t, "name", 7), n = V(t, "variant", 7), i = V(t, "decorative", 7, !0), s = V(t, "label", 7), a = V(t, "title", 7), o = V(t, "size", 7, "1rem"), c = V(t, "className", 7, ""), l = /* @__PURE__ */ U(() => Gd(r(), n())), f = /* @__PURE__ */ U(() => s() ?? a() ?? r());
  var m = {
    get name() {
      return r();
    },
  ...
  return Ee(
    (g) => {
      rt(p, 1, g, "svelte-1a09gvd"), ne(p, "aria-hidden", i()), ne(p, "aria-label", i() ? void 0 : d(f)), ne(p, "role", i() ? void 0 : "img"), ne(p, "title", a()), y = Ge(p, "", y, { "--icon-mask": d(l), width: o(), height: o() });
    },
    [() => Td(`app-icon ${c()}`.trim())]
  ), J(e, p), Hi(m);
}
...
function Ho(e, t) {
  Vi(t, !0), Hs(e, xc);
  let r = V(t, "title", 7), n = V(t, "state", 15, "normal"), i = V(t, "x", 15, 100), s = V(t, "y", 15, 100), a = V(t, "width", 15, 600), o = V(t, "height", 15, 400), c = V(t, "locked", 7, !1), l = V(t, "chromeless", 7, !1), f = V(t, "buttonLayout", 7), m = V(t, "systemButtonPlacement", 7), p = V(t, "sideResizeMode", 7), y = V(t, "borderWidth", 7), g = V(t, "borderRadius", 7), z = V(t, "chromePadding", 7), b = V(t, "chromeStyle", 7), q = V(t, "alignment", 7), A = V(t, "themePreset", 7), k = V(t, "fontPreset", 7), H = V(t, "snapRestoreOnRelease", 7), te = V(t, "shiftDragAction", 7), Q = V(t, "zIndex", 7, 100), Y = V(t, "pinned", 7, !1), ue = V(t, "dragSeed", 7, null), R = V(t, "onClose", 7), me = V(t, "onPinToggle", 7), ve = V(t, "onConsumeDragSeed", 7), de = V(t, "onStateChange", 7), De = V(t, "children", 7);
  const Xe = [
  ...
  let ze = /* @__PURE__ */ I(Cr({ ...ke })), $n = /* @__PURE__ */ I(!1), yr = /* @__PURE__ */ I(!1), Ke = /* @__PURE__ */ I(null), j = /* @__PURE__ */ I(null), F = /* @__PURE__ */ I(null), ae = /* @__PURE__ */ I(null), Z = /* @__PURE__ */ I(0), Ct = /* @__PURE__ */ I(0), xr = "", Qr = 0, en = 0, Kt = 0, jn = 0, qt = 0, _r = 0, Je = "se", Jt = null, Lt = !1, dt = !1, zn = 0.5, ci = 18, It = !1, kr = /* @__PURE__ */ I(null), Ot = 0, Dt = /* @__PURE__ */ I(null), Rn = /* @__PURE__ */ I(0), En = /* @__PURE__ */ I(0);
  Io(() => {
  ...
  let be = /* @__PURE__ */ U(() => f() ?? d(ze).buttonLayout), Gi = /* @__PURE__ */ U(() => m() ?? d(ze).systemButtonPlacement), ui = /* @__PURE__ */ U(() => p() ?? d(ze).sideResizeMode), he = /* @__PURE__ */ U(() => y() ?? d(ze).borderWidth), qe = /* @__PURE__ */ U(() => g() ?? d(ze).borderRadius), fe = /* @__PURE__ */ U(() => z() ?? d(ze).chromePadding), G = /* @__PURE__ */ U(() => b() ?? d(ze).chromeStyle), Me = /* @__PURE__ */ U(() => q() ?? d(ze).alignment), ct = /* @__PURE__ */ U(() => A() ?? d(ze).themePreset), ut = /* @__PURE__ */ U(() => k() ?? d(ze).fontPreset), Qe = /* @__PURE__ */ U(() => H() ?? d(ze).snapRestoreOnRelease), Qt = /* @__PURE__ */ U(() => te() ?? d(ze).shiftDragAction), ht = /* @__PURE__ */ U(() => a() < 560 ? "left" : d(Me)), ft = /* @__PURE__ */ U(() => a() < 520), tn = /* @__PURE__ */ U(() => Math.max(d(Rn), d(En)) + (d(ft) ? 12 : 18));
  function Nt(u) {
    return Kr.has(u);
  }
  function er(u) {
  ...
  let pt = /* @__PURE__ */ I(!1), qr = 0, nr = 0, Mr = 0, ir = 0, hi = /* @__PURE__ */ U(() => d(pt) && !l() && !c() && d(be) !== "mac" && typeof window < "u" && d(Ct) <= 84 && Math.abs(d(Z) - window.innerWidth / 2) <= 232), Sr = /* @__PURE__ */ U(() => d(Ke) ? An(d(Ke)) : null);
  function mt(u) {
    var v;
  ...
  function Tn() {
    return typeof window > "u" ? { x: 96, y: 72, width: 920, height: 640 } : vt({
  ...
  function rn(u) {
    const v = vt(u);
    i(v.x), s(v.y), a(v.width), o(v.height), w(j, null), mt("normal");
  }
  function fi() {
    rn(d(F) ?? Tn());
  }
  function An(u) {
    ...
    const v = window.innerWidth, M = window.innerHeight, P = Math.round(v / 2), re = Math.round(M / 2);
    switch (u) {
      case "maximize":
      ...
      case "top-left":
        return { x: 0, y: 0, width: P, height: re };
      case "top-right":
        return {
          x: v - P,
          y: 0,
  ...
  function Cn(u, v = sr()) {
    if (w(F, vt(v), !0), u === "maximize") {
      typeof window < "u" && (i(0), s(0), a(window.innerWidth), o(window.innerHeight)), w(j, "maximize"), mt("maximized");
      return;
    }
    const M = An(u);
    M && (w(j, u, !0), mt("normal"), i(M.x), s(M.y), a(M.width), o(M.height));
  }
  function pi() {
  ...
  function mi() {
    mt(n() === "rolled-up" ? "normal" : "rolled-up");
  }
  function Ln() {
    mt("minimized");
  }
  ...
  function Zi() {
    ...
    if (typeof window > "u" || !d(Dt))
      return !1;
    const u = 24, v = Math.ceil(Math.max(d(Dt).scrollWidth, ((re = d(Dt).firstElementChild) == null ? void 0 : re.scrollWidth) ?? 0)), M = Math.ceil(Math.max(d(Dt).scrollHeight, ((oe = d(Dt).firstElementChild) == null ? void 0 : oe.scrollHeight) ?? 0)), P = vt({
  ...
  function wi(u, v) {
    if (w(Z, u, !0), w(Ct, v, !0), !d(pt) || c() || l() || d(be) === "mac") {
      w(Ke, null);
      return;
    }
    w(Ke, Xi(u, v) ?? Wt(u, v), !0);
  }
  function Bo(u, v) {
    if (!dt) return;
    const M = d(F) ?? Tn(), P = vt({
    ...
    i(P.x), s(P.y), a(P.width), o(P.height), mt("normal"), w(j, null), dt = !1, Lt = !0, qr = u, nr = v, Mr = i(), ir = s();
  }
  function Us(u) {
    !u.shiftKey || It || d(Qt) !== "pin" || !me() || Y() || (me()(), It = !0);
  }
  function Uo(u) {
    if (c() || l() || n() === "minimized" || Dn(u.target)) return;
    w(pt, !0), It = !1, w(Ke, null), w(Z, u.clientX, !0), w(Ct, u.clientY, !0), qr = u.clientX, nr = u.clientY, Mr = i(), ir = s(), Lt = !1, dt = !1;
    const v = sr();
    zn = v.width <= 0 ? 0.5 : Math.max(0.1, Math.min(0.9, (u.clientX - v.x) / v.width)), ci = Math.max(12, Math.min(28, Math.round(u.clientY - v.y || 18))), n() === "maximized" || d(j) ? (Jt = n() === "maximized" ? "maximize" : d(j), w(F, d(F) ?? Tn(), !0), dt = !0) : Jt = null, Us(u), u.currentTarget.setPointerCapture(u.pointerId);
  }
  function Ki(u) {
    d(pt) && (Us(u), dt && (Math.abs(u.clientX - qr) > 2 || Math.abs(u.clientY - nr) > 2) && Bo(u.clientX, u.clientY), i($r(Mr + (u.clientX - qr), a())), s(Pn(ir + (u.clientY - nr), o())), wi(u.clientX, u.clientY));
  }
  function nn(u) {
    if (!d(pt)) return;
    const v = d(Ke);
    w(Ke, null), w(pt, !1), dt = !1, v ? Cn(v, sr()) : Lt && Jt && d(Qe) && !u.shiftKey && !It ? Cn(Jt, sr()) : w(j, null), Jt = null, Lt = !1, It = !1;
  ...
  function Yo(u, v) {
    c() || l() || n() === "maximized" || n() === "minimized" || (d(j) && w(j, null), v.stopPropagation(), v.preventDefault(), w(yr, !0), Je = u, Qr = v.clientX, en = v.clientY, Kt = i(), jn = s(), qt = a(), _r = o(), w(Ke, null), window.addEventListener("pointermove", Ys), window.addEventListener("pointerup", Nn), window.addEventListener("pointercancel", Nn));
  }
  function Ys(u) {
    if (!d(yr)) return;
    const v = u.clientX - Qr, M = u.clientY - en;
    let P = Kt, re = jn, oe = qt, Te = _r;
    if (d(ui) === "mirrored" && (Je === "e" || Je === "w")) {
      const zr = Je === "e" ? v : -v;
      oe = Math.max(kt, qt + zr * 2), P = Kt - (oe - qt) / 2;
    } else Je.includes("e") && (oe = Math.max(kt, qt + v));
    Je.includes("s") && (Te = Math.max(At, _r + M)), d(ui) !== "mirrored" && Je.includes("w") && (oe = Math.max(kt, qt - v), P = Kt + (qt - oe)), Je.includes("n") && (Te = Math.max(At, _r - M), re = jn + (_r - Te));
    const ar = vt({ x: P, y: re, width: oe, height: Te });
  ...
  function Go(u) {
    ...
    i(v.x), s(v.y), Mr = i(), ir = s(), qr = u.clientX, nr = u.clientY, w(Z, u.clientX, !0), w(Ct, u.clientY, !0), w(Ke, null), Jt = null, Lt = !1, dt = !1, It = !0, w(pt, !0), window.addEventListener("pointermove", Ki), window.addEventListener("pointerup", nn), window.addEventListener("pointercancel", nn), (M = ve()) == null || M();
  }
  go(() => {
  ...
  var Xs = E(Zs, 2);
  {
    var Ko = (u) => {
      var v = uc();
      let M;
      Qn(v, 21, () => Xe, (P) => P.id, (P, re) => {
        var oe = cc();
        let Te;
        var ar = _(oe);
        x(oe), Ee(() => {
          Te = rt(oe, 1, "snap-cell svelte-1k3ojqh", null, Te, { "is-active": d(Ke) === d(re).id }), ne(oe, "data-snap-target", d(re).id), rt(ar, 1, `snap-shape shape-${d(re).preview}`, "svelte-1k3ojqh");
        }), J(P, oe);
      }), x(v), zs(v, (P) => w(ae, P), () => d(ae)), Ee(() => M = Ge(v, "", M, { "z-index": Q() + 3 })), J(u, v);
    };
    Ye(Xs, (u) => {
      d(hi) && !l() && u(Ko);
    });
  ...
  var Qs = _(Vt);
  {
    var Jo = (u) => {
      ...
      var P = _(v), re = _(P);
      {
        var oe = (we) => {
          ...
          Mt(Vn, { name: "pin" }), x(Ne), Ee(() => {
            wt = rt(Ne, 1, "window-button svelte-1k3ojqh", null, wt, { "is-active": Y() }), ne(Ne, "aria-label", Y() ? "Unpin window" : "Pin window"), ne(Ne, "aria-pressed", Y());
          }), ie("click", Ne, function(...We) {
            var sn;
        ...
        var sl = (we) => {
          var Ne = pc(), wt = un(Ne);
          {
            var Vn = (Re) => {
              ...
              x(ye), ie("click", ye, function(...Rr) {
                var Hn;
                (Hn = R()) == null || Hn.apply(this, Rr);
              }), J(Re, ye);
            };
            Ye(wt, (Re) => {
              R() && Re(Vn);
          ...
          x(an), Ee(() => {
            ne(We, "aria-label", n() === "minimized" ? "Restore window" : "Minimize window"), ne(an, "aria-label", n() === "maximized" ? "Restore window" : "Maximize window");
          }), ie("click", We, () => n() === "minimized" ? mt("normal") : Ln()), ie("click", an, jr), J(we, Ne);
        }, al = /* @__PURE__ */ U(() => Nt(d(be))), ol = (we) => {
          var Ne = vc(), wt = un(Ne), Vn = _(wt);
          {
            let Re = /* @__PURE__ */ U(() => n() === "minimized" ? "restore" : "minimize"), ye = /* @__PURE__ */ U(() => tr(d(be), n() === "minimized"));
            Mt(Vn, {
              get name() {
          ...
          Ee(() => {
            ne(wt, "aria-label", n() === "minimized" ? "Restore window" : "Minimize window"), ne(We, "aria-label", n() === "maximized" ? "Restore window" : "Maximize window");
          }), ie("click", wt, () => n() === "minimized" ? mt("normal") : Ln()), ie("click", We, jr), J(we, Ne);
        };
        Ye(il, (we) => {
          d(al) ? we(sl) : we(ol, -1);
        });
      ...
      x(Ji), x(v), Ee(
        (we) => {
          M = rt(v, 1, `window-chrome chrome-${d(G) ?? ""}`, "svelte-1k3ojqh", M, we), ne(v, "aria-label", `${r()} window controls`), ta = rt(zr, 1, "window-button svelte-1k3ojqh", null, ta, { "is-active": n() === "rolled-up" }), ne(zr, "aria-label", n() === "rolled-up" ? "Restore height" : "Roll up"), rt(Wn, 1, `window-title align-${d(ht) ?? ""}`, "svelte-1k3ojqh"), ne(Wn, "title", r()), Ae(nl, r());
        },
        [
          () => ({
            "layout-mac": Nt(d(be)),
      ...
      ), ie("pointerdown", v, Uo), ie("pointermove", v, Ki), ie("pointerup", v, nn), xd("pointercancel", v, nn), ie("dblclick", v, vi), ie("click", Te, pi), ie("click", zr, mi), wa(P, "clientWidth", (we) => w(Rn, we)), wa(Ji, "clientWidth", (we) => w(En, we)), J(u, v);
    };
    Ye(Qs, (u) => {
      l() || u(Jo);
    });
  ...
  var ea = E(Qs, 2);
  {
    var Qo = (u) => {
      var v = gc(), M = _(v);
      jd(M, () => De() ?? hn), x(v), zs(v, (P) => w(Dt, P), () => d(Dt)), J(u, v);
    };
    Ye(ea, (u) => {
  ...
  var el = E(ea, 2);
  {
    var tl = (u) => {
      ...
      Qn(M, 16, () => br, (P) => P, (P, re) => {
        var oe = bc();
        Ee(() => rt(oe, 1, `resize-handle dir-${re}`, "svelte-1k3ojqh")), ie("pointerdown", oe, (Te) => Yo(re, Te)), J(P, oe);
      }), J(u, v);
    };
    Ye(el, (u) => {
  ...
  return x(Vt), Ee(() => {
    Ks = rt(Vt, 1, "window-shell svelte-1k3ojqh", null, Ks, {
      "is-ready": d($n),
      "is-dragging": d(pt),
      "is-resizing": d(yr),
      "compact-controls": d(ft),
      maximized: n() === "maximized",
      minimized: n() === "minimized",
      "rolled-up": n() === "rolled-up",
      chromeless: l()
    }), ne(Vt, "data-layout", d(be)), ne(Vt, "data-system-placement", d(Gi)), ne(Vt, "data-style", d(G)), ne(Vt, "data-theme", d(ct)), ne(Vt, "data-font", d(ut)), Js = Ge(Vt, "", Js, {
...
function kc(e, t, r) {
  ...
  let l = 0;
  const f = (a + o) / 2, m = c === 0 ? 0 : c / (1 - Math.abs(2 * f - 1));
  if (c !== 0) {
    switch (a) {
      case n:
        l = (i - s) / c % 6;
...
function qc(e, t, r) {
  ...
  let l = 0, f = 0, m = 0;
  return n < 60 ? (l = a, f = o) : n < 120 ? (l = o, f = a) : n < 180 ? (f = a, m = o) : n < 240 ? (f = o, m = a) : n < 300 ? (l = o, m = a) : (l = a, m = o), {
    r: (l + c) * 255,
    g: (f + c) * 255,
    b: (m + c) * 255
  };
...
function Un(e, t = Zn, r = ln, n = dn) {
  const i = Bs(e), s = Ei(i), { h: a, s: o, l: c } = kc(s.r, s.g, s.b), l = t === "dark", f = $a(r, 0, 100, -16, 18), m = $a(n, 0, 100, -12, 14), p = i, y = Bn(
    a,
    X(o + 6 + f * 0.5, 18, 98),
    X(c + (l ? 10 : -12) - m * 0.2, 16, 78)
  ), g = Pr(
    p,
    l ? "#0b1220" : "#ffffff",
    l ? 0.74 : 0.82
    ...
    a + 2,
    X(8 + o * 0.08, 6, 18),
    l ? X(10 + m * 0.34, 7, 18) : X(98 - m * 0.24, 93, 99)
  ), A = Bn(
    a + 8,
    X(10 + o * 0.1, 7, 20),
    l ? X(14 + m * 0.38, 10, 23) : X(95 - m * 0.18, 90, 97)
  ), k = Bn(
    a,
    X(8 + o * 0.06, 5, 16),
    l ? X(8 + m * 0.24, 5, 14) : X(92 - m * 0.18, 88, 95)
  ), H = Pr(A, p, l ? 0.18 : 0.1), te = Pr(H, y, 0.32), Q = l ? "#e6eefc" : "#0f172a", Y = l ? Pr(Q, q, 0.45) : Pr(Q, q, 0.58), ue = Pr(p, l ? "#ffffff" : "#0f172a", l ? 0.18 : 0.1), R = l ? "#3ddc97" : "#138a5b", me = l ? "#f6b73c" : "#b66a00", ve = l ? "#ff6b81" : "#c92a4b", de = Sa(p), De = Sa(z), Xe = l ? "0 18px 60px rgba(0, 0, 0, 0.44), 0 6px 20px rgba(0, 0, 0, 0.28)" : "0 18px 60px rgba(15, 23, 42, 0.16), 0 6px 20px rgba(15, 23, 42, 0.08)";
  return {
    seed: i,
    mode: t,
...
function Sc() {
  ...
  return {
    ...
    hydrate() {
      ...
      if (i)
        try {
          const s = JSON.parse(i), a = Bs(s.seed), o = s.mode === "dark" ? "dark" : "light", c = X(Number(s.vividness ?? ln), 0, 100), l = X(Number(s.contrast ?? dn), 0, 100), f = Un(a, o, c, l);
          r({
            seed: a,
            mode: o,
            vividness: c,
...
function Lc(e, t) {
  ...
  let o = /* @__PURE__ */ I(!1), c = /* @__PURE__ */ I(!1), l = /* @__PURE__ */ I("normal"), f = /* @__PURE__ */ I("theme"), m = /* @__PURE__ */ I("toolbar"), p = /* @__PURE__ */ I(null), y = /* @__PURE__ */ I(null), g = /* @__PURE__ */ I(s), z = /* @__PURE__ */ I(s), b = /* @__PURE__ */ I(r), q = /* @__PURE__ */ I(n), A = /* @__PURE__ */ I("#5b8cff"), k = /* @__PURE__ */ I("light"), H = /* @__PURE__ */ I(66), te = /* @__PURE__ */ I(56), Q = /* @__PURE__ */ I("Copy CSS"), Y = /* @__PURE__ */ I("One seed color drives the whole palette.");
  const ue = [
    { id: "theme", label: "Theme" },
    { id: "presets", label: "Presets" },
    { id: "tokens", label: "Tokens" }
  ], R = /* @__PURE__ */ U(() => lr.preview(d(A), d(k), d(H), d(te)));
  function me(j = d(m)) {
    const F = j === "toolbar" ? ["toolbar-theme-trigger", "fab-theme-trigger"] : ["fab-theme-trigger", "toolbar-theme-trigger"];
    for (const ae of F) {
  ...
  function ve() {
    ...
    const j = d(p).getBoundingClientRect(), F = Math.min(r, Math.max(360, window.innerWidth - s * 2)), ae = Math.min(n, Math.max(420, window.innerHeight - s * 2));
    let Z = j.right - F, Ct = d(m) === "toolbar" ? j.bottom + i : j.top - ae - i;
    Z = Math.min(Math.max(s, Z), Math.max(s, window.innerWidth - F - s)), Ct = Math.min(Math.max(s, Ct), Math.max(s, window.innerHeight - ae - s)), w(b, Math.round(F), !0), w(q, Math.round(ae), !0), w(g, Math.round(Z), !0), w(z, Math.round(Ct), !0);
  }
  function de(j) {
    var ae;
    const F = (ae = j == null ? void 0 : j.detail) == null ? void 0 : ae.source;
    return F === "toolbar" || F === "fab" ? F : null;
  }
  function De(j) {
    const F = de(j) ?? d(m), ae = d(m);
    if (w(m, F, !0), d(l) === "minimized" && w(l, "normal"), d(c)) {
      w(o, !0);
      return;
    }
    if (d(o) && ae === F) {
  ...
  function br(j) {
    if (!d(o) || d(c)) return;
    const F = j.composedPath();
    d(y) && F.includes(d(y)) || d(p) && F.includes(d(p)) || Xe();
  }
  function kt(j) {
    const F = j.trim().replace("#", "");
    return /^[0-9a-fA-F]{6}$/.test(F) ? `#${F.toLowerCase()}` : /^[0-9a-fA-F]{3}$/.test(F) ? `#${F.split("").map((ae) => `${ae}${ae}`).join("").toLowerCase()}` : d(A);
  }
  async function At() {
    ...
    await navigator.clipboard.writeText(Mc(d(R))), w(Q, "Copied"), w(Y, "CSS variables copied to clipboard."), setTimeout(
      () => {
        w(Q, "Copy CSS");
      },
      1600
  ...
  function je() {
    const j = lr.apply(d(A), d(k), d(H), d(te));
  ...
  function Jr() {
    ...
    w(A, j.seed, !0), w(k, j.mode, !0), w(H, j.vividness, !0), w(te, j.contrast, !0), us(j), w(Y, "Theme reset to the default shell palette.");
  }
  function ze(j) {
    w(A, j.seed, !0), w(k, j.mode, !0), w(H, j.vividness, !0), w(te, j.contrast, !0), w(f, "theme"), w(Y, `${j.label} loaded.`);
  }
  Io(() => {
    ...
    const j = Gl(lr);
    return w(A, j.seed, !0), w(k, j.mode, !0), w(H, j.vividness, !0), w(te, j.contrast, !0), us(j.palette), me(d(m)), ve(), () => {
      ...
      Ho(ae, {
        ...
        children: (Z, Ct) => {
          ...
          Qn(Lt, 21, () => ue, (he) => he.id, (he, qe) => {
            ...
            var Me = _(fe, !0);
            x(fe), Ee(() => {
              G = rt(fe, 1, "studio-tab svelte-1m44pqp", null, G, { active: d(f) === d(qe).id }), Ae(Me, d(qe).label);
            }), ie("click", fe, () => w(f, d(qe).id, !0)), J(he, fe);
          }), x(Lt);
          var dt = E(Lt, 2), zn = _(dt);
          {
            var ci = (he) => {
              var qe = jc(), fe = un(qe), G = E(_(fe), 4), Me = _(G), ct = _(Me);
              yi(ct), Tr(2), x(Me);
              var ut = E(Me, 2), Qe = E(_(ut), 2);
              yi(Qe), x(ut);
              var Qt = E(ut, 2), ht = _(Qt);
              let ft;
              var tn = E(ht, 2);
              let Nt;
              x(Qt), x(G);
              var er = E(G, 2), tr = _(er), rr = _(tr), pt = E(_(rr), 2), qr = _(pt, !0);
              x(pt), x(rr);
              var nr = E(rr, 2);
              yi(nr), x(tr);
              ...
              Tr(2), x($r);
              var vt = E($r, 2), Tn = _(vt);
              Tr(2), x(vt);
              var rn = E(vt, 2), fi = _(rn);
              Tr(2), x(rn);
              ...
              x(Dn), x(vi), x(Ln), Tr(2), x(mi), x(jr), x(pi), Ee(() => {
                Nd(Qe, d(A)), ft = rt(ht, 1, "svelte-1m44pqp", null, ft, { active: d(k) === "light" }), Nt = rt(tn, 1, "svelte-1m44pqp", null, Nt, { active: d(k) === "dark" }), Ae(qr, d(H)), Ae(Sr, d(te)), Ge(Pn, `background:${d(R).accent}`), Ge(Tn, `background:${d(R).accentStrong}`), Ge(fi, `background:${d(R).accentSecondary}`), Ge(Cn, `background:${d(R).surfaceAlt}`), Ae(Zi, d(R).accent), Ae(Xi, d(R).accentSecondary);
              }), as(ct, () => d(A), (Wt) => w(A, Wt)), ie("input", Qe, (Wt) => {
                const wi = Wt.currentTarget;
                w(A, kt(wi.value), !0), wi.value = d(A);
              }), ie("click", ht, () => w(k, "light")), ie("click", tn, () => w(k, "dark")), as(nr, () => d(H), (Wt) => w(H, Wt)), as(mt, () => d(te), (Wt) => w(te, Wt)), J(he, qe);
            };
            Ye(zn, (he) => {
              d(f) === "theme" && he(ci);
            });
          ...
          var It = E(zn, 2);
          {
            var kr = (he) => {
              ...
              Qn(qe, 21, () => _c, (fe) => fe.id, (fe, G) => {
                var Me = zc(), ct = _(Me), ut = _(ct), Qe = E(ut, 2), Qt = E(Qe, 2);
                x(ct);
                var ht = E(ct, 2), ft = _(ht), tn = _(ft, !0);
                x(ft);
                var Nt = E(ft, 2), er = _(Nt);
                x(Nt), x(ht), x(Me), Ee(
                  (tr, rr) => {
                    Ge(ut, `background:${d(G).seed}`), Ge(Qe, tr), Ge(Qt, rr), Ae(tn, d(G).label), Ae(er, `${d(G).seed ?? ""} · ${d(G).mode ?? ""}`);
                  },
                  [
          ...
          var Ot = E(It, 2);
          {
            var Dt = (he) => {
              ...
              Qn(
                ...
                () => [
                  ["--accent", d(R).accent],
                  ["--accent-strong", d(R).accentStrong],
                  ["--accent-soft", d(R).accentSoft],
                  ["--accent-secondary", d(R).accentSecondary],
                  [
                    "--accent-secondary-soft",
                    d(R).accentSecondarySoft
                  ],
                  ["--surface", d(R).surface],
                  ["--surface-alt", d(R).surfaceAlt],
                  ["--surface-inset", d(R).surfaceInset],
                  ["--border", d(R).border],
                  ["--border-strong", d(R).borderStrong],
                  ["--text", d(R).text],
                  ["--text-muted", d(R).textMuted]
                ],
                (fe) => fe[0],
                (fe, G) => {
                  var Me = Ec(), ct = _(Me), ut = E(ct, 2), Qe = _(ut), Qt = _(Qe, !0);
                  x(Qe);
                  var ht = E(Qe, 2), ft = _(ht, !0);
                  x(ht), x(ut), x(Me), Ee(() => {
                    Ge(ct, `background:${d(G)[1]}`), Ae(Qt, d(G)[0]), Ae(ft, d(G)[1]);
                  }), J(fe, Me);
                }
              ), x(qe), J(he, qe);
            };
          ...
          x(dt);
          var Rn = E(dt, 2), En = _(Rn), be = E(En, 2), Gi = _(be, !0);
          x(be);
          var ui = E(be, 2);
          x(Rn), x(xr), Ee(() => {
            Ge(xr, `--preview-accent:${d(R).accent};
                --preview-accent-strong:${d(R).accentStrong};
                --preview-accent-soft:${d(R).accentSoft};
                --preview-secondary:${d(R).accentSecondary};
                --preview-secondary-soft:${d(R).accentSecondarySoft};
                --preview-surface:${d(R).surface};
                --preview-surface-alt:${d(R).surfaceAlt};
                --preview-surface-inset:${d(R).surfaceInset};
                --preview-border:${d(R).border};
                --preview-border-strong:${d(R).borderStrong};
                --preview-text:${d(R).text};
                --preview-text-muted:${d(R).textMuted};
                --preview-on-accent:${d(R).onAccent};
                --preview-shadow:${d(R).shadow};`), Ae(jn, d(m) === "toolbar" ? "Toolbar launch" : "Fab launch"), Ae(_r, d(Y)), ne(Je, "data-mode", d(k)), Ae(Jt, d(k) === "dark" ? "Dark mode" : "Light mode"), Ae(Gi, d(Q));
          }), ie("click", En, Jr), ie("click", be, At), ie("click", ui, je), J(Z, xr);
        },
        $$slots: { default: !0 }
      }), x(F), zs(F, (Z) => w(y, Z), () => d(y)), J(j, F);
    };
    Ye(yr, (j) => {
      d(o) && j(Ke);
    });
